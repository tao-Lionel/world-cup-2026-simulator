...
const steps = [
  ...
  ["生成球员本季俱乐部表现", "build-player-club-season-snapshot.mjs"],
  ["聚合队级俱乐部表现", "build-squad-club-season-profile.mjs"],
  ["写回队级俱乐部表现", "apply-squad-club-season-profile.mjs"],
  ...
  ["生成国际赛果上下文", "build-international-context.mjs"],
  ["写回世预赛表现", "apply-qualifying-performance.mjs"],
