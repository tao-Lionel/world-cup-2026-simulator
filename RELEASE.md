...
- FIFA 排名、Elo、赔率、近况、世界杯历史路径、阵容、伤病、俱乐部分布、赛程旅行、休息、比赛日天气/场馆环境和球队上下文的多因子模型。
...
- `data/squads_2026.csv` 当前覆盖 48 队、1247 名在册球员；Argentina 因 Leonardo Balerdi 伤退、替补尚未公布而暂为 25 人。
